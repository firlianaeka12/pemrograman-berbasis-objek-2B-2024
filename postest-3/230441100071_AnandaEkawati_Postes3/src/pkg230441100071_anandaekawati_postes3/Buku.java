...
class Buku extends MediaInformasi {
   ...
   @Override
    ...
    public void displayInfo(String tambahanInfo) {
        System.out.println("Judul: " + judul +"("+tambahanInfo+")" );
        System.out.println("Pengarang: " + pengarang );
        System.out.println("Tahun Terbit: " + tahunTerbit );
        System.out.println("");
    }
    ...
    public static void main(String[] args) {
        ...
        buku1.displayInfo("Novel Best Seller");
        buku2.displayInfo("Pemenang Penghargaan");
